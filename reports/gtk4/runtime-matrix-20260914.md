...
The matrix was rerun from the synchronized development share; all eleven
...
| Home inventory | All eleven verified GTK4 bundles exposed through `SUGAR_ACTIVITIES_PATH` | PASS |
| Activity lifecycle | Help, Count, Calculate, Clock, JAMClock, Image Viewer, Terminal, Browse, Log, Mastermind, Poll (`283436`–`283466`) | PASS: every launch/stop reported `cleanup=PASS` |
| Casilda | Eleven real Journal launch/stop cycles | PASS |
