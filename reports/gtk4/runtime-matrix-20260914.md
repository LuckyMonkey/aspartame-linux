...
The matrix was rerun from the synchronized `origin/master` checkout; all
nine modern bundles completed a live launch/stop cycle (latest Activity PIDs
`277435`–`277585`).
...
| Activity lifecycle | Help, Count, Calculate, Clock, JAMClock, Image Viewer, Terminal, Browse, Log (`277435`–`277585`) | PASS: every launch/stop reported `cleanup=PASS` |
