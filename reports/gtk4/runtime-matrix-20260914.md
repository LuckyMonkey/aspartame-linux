...
latest addition; Color My World has a separate three-cycle probe ending at PID
`393077`.
...
| Activity lifecycle | Full 35-bundle matrix (`384832` latest), TurtleBlocks (`387729`), Game Of Life (`390403`), and Color My World (`393077`) | PASS: all 114 recorded launch/stop cycles reported `cleanup=PASS` |
