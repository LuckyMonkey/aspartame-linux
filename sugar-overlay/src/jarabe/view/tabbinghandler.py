...
class TabbingHandler(object):
    ...
    def next_activity(self, event_time):
        ...
        if self._tabbing:
            ...
            self._activate_previous_activity(event_time)
    ...
    def _activate_previous_activity(self, event_time):
        previous_activity = shell.get_model().get_previous_activity()
        if previous_activity:
            previous_activity.get_window().activate(event_time)
