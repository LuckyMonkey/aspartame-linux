...
| Mastermind, Poll, Mancala, Reversi, Jumble, NumberRush, Across and Down, IQ, Appel Haken, BallAndBrick, Implode, PlayGo, BlockParty, Typing Turtle, Memorize, Maze, Last One Loses, Gears, TurtleBlocks, Game Of Life, Color My World, Connect the Dots, Diamond Fusion, Level, Moon | 3-cycle matrix evidence | COVERAGE IMPLEMENTATION |
