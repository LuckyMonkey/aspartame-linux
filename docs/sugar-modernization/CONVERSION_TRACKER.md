...
- [ ] Physical-event Tab/Shift+Tab/Enter/Space (QMP F1–F6 and F6→Escape now
      reach GTK4 through the explicit virtio keyboard, including F4 on a live
      Activity; remaining focus/input actions still need evidence)
