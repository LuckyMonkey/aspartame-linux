...
| Fructose activities | Arch packages plus pinned bundled set | Mixed but runnable | Thirty-four modern Activities launch through the GTK4 toolkit/Casilda boundary | Individual GTK4 ports verified | Port one activity at a time, never mass-convert |
...
| Mastermind, Poll, Mancala, Reversi, Jumble, NumberRush, Across and Down, IQ, Appel Haken, BallAndBrick, Implode, PlayGo, BlockParty, Typing Turtle, Memorize, Maze, FotoToon, Portfolio, Markdown, Finance, Words, Last One Loses, Get Things Done, Grid Paint, Stopwatch | GTK3 legacy Activities | Native GTK4 bundles | Self-contained logic, survey, board, word, arithmetic, crossword, sequence, colour, brick-breaker, matching-block, Go-board, block-arrangement, typing, card-matching, maze, caption-canvas, document-canvas, Markdown editor, budget-tracking, language, take-away game, task-list, grid-drawing, and elapsed-time interactions | GTK4 verified 2026-09-14 | Stopwatch is included in the direct repeated lifecycle probe |
