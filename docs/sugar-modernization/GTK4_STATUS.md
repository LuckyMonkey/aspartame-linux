...
| Fructose activities | Arch packages plus pinned bundled set | Mixed but runnable | Forty-one modern Activities launch through the GTK4 toolkit/Casilda boundary | Individual GTK4 ports verified | Port one activity at a time, never mass-convert |
