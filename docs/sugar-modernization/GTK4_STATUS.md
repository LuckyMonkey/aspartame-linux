...
| Fructose activities | Arch packages plus pinned bundled set | Mixed but runnable | Forty-nine modern Activities have verified GTK4 launch/stop coverage | Runtime coverage verified; parity classification is separate | See `ACTIVITY_PORT_CLASSIFICATION.md`; do not treat the matrix as full ports |
