...
| Fructose activities | Arch packages plus pinned bundled set | Mixed but runnable | Help, Log, Count, Calculate, Clock, JAMClock, Image Viewer, Terminal, and Browse launch through the GTK4 toolkit/Casilda boundary | Individual GTK4 ports verified | Port one activity at a time, never mass-convert |
