...
| Fructose activities | Arch packages plus pinned bundled set | Mixed but runnable | Fifteen modern Activities launch through the GTK4 toolkit/Casilda boundary | Individual GTK4 ports verified | Port one activity at a time, never mass-convert |
...
| Mastermind, Poll, Mancala, Reversi, Jumble, NumberRush | GTK3 legacy Activities | Native GTK4 bundles | Self-contained logic, survey, board, word, and arithmetic interactions | GTK4 verified 2026-09-14 | All six are included in the repeated 3-cycle Activity matrix |
