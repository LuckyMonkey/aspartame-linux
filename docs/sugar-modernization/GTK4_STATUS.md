...
| Fructose activities | Arch packages plus pinned bundled set | Mixed but runnable | Twenty-four modern Activities launch through the GTK4 toolkit/Casilda boundary | Individual GTK4 ports verified | Port one activity at a time, never mass-convert |
...
| Mastermind, Poll, Mancala, Reversi, Jumble, NumberRush, Across and Down, IQ, Appel Haken, BallAndBrick, Implode, PlayGo, BlockParty, Typing Turtle, Memorize | GTK3 legacy Activities | Native GTK4 bundles | Self-contained logic, survey, board, word, arithmetic, crossword, sequence, colour, brick-breaker, matching-block, Go-board, block-arrangement, typing, and card-matching interactions | GTK4 verified 2026-09-14 | All fifteen are included in the repeated 3-cycle Activity matrix |
