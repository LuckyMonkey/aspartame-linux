...
class Palette(PaletteWindow):
    ...
    def __init__(
        ...
        self._primary_event_box.add_css_class("sugar-palette-header")
        ...
        self._label.add_css_class("sugar-palette-primary")
        ...
        self._secondary_label.add_css_class("sugar-palette-secondary")
        ...
        self._secondary_box.add_css_class("sugar-palette-secondary-box")
    ...
    def _add_content(self):
        ...
        self._content.add_css_class("sugar-palette-content")
    ...
    def set_content(self, widget):
        ...
        if self._widget is None:
            ...
            self._palette_box.add_css_class("sugar-palette-box")
