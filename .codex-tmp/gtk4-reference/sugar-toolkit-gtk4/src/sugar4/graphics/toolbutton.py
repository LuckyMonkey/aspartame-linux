...
class ToolButton(Gtk.Button):
    ...
    def set_tooltip(self, tooltip: Optional[str]):
        ...
        """
        # Sugar palettes are the tooltip implementation.  Explicitly clear
        # GTK native tooltip text so a second, desktop-themed popup is never
        # created alongside the palette.
