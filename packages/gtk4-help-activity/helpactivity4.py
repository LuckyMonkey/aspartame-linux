...
class HelpActivity(SimpleActivity):
    def __init__(self, activity_handle=None):
        ...
        sections = (
            ...
            ("Journal", "The Journal saves work as objects rather than a traditional file tree. Search by title or Activity, inspect metadata, resume an entry, or open it in its associated Activity. Stopping an Activity does not delete its Journal entries."),
            ...
            ("Terminal and Browse Activities", "Terminal provides a native GTK4 shell inside Sugar and keeps its text input in the Activity surface. Browse opens web content in its GTK4 WebKit surface. Both are isolated Activities: use the Frame to switch away, and use the Activity stop control to end them and return to Home."),
